		...
		<div class="container-fluid">
		  ...
		  <div class="row">
			...
			<div class="col-md-4 col-sm-4">
                ...
                $vertical6=DB::table('ads')->where('type',1)->skip(5)->first();
      @endphp
      <!-- add-start -->
          <div class="row">
              <div class="col-md-12 col-sm-12">
                  <div class="sidebar-add">
                   ...
                   <div class="sidebar-add">
                    @if($vertical6==NULL)
                    @else
                    <a href="{{ $vertical6->link }}" target="_blank"><img src="{{ asset($vertical6->ads) }}" alt="" /></a>
                    @endif
                  </div>
				...
				<!-- add-start -->
					 @php
                                   $vertical7=DB::table('ads')->where('type',1)->skip(6)->first();
                                   $vertical8=DB::table('ads')->where('type',1)->skip(7)->first();
                         @endphp
                         <!-- add-start -->
                             <div class="row">
                                 <div class="col-md-12 col-sm-12">
                                     <div class="sidebar-add">
                                        @if($vertical7==NULL)
                                        @else
                                        <a href="{{ $vertical7->link }}" target="_blank"><img src="{{ asset($vertical7->ads) }}" alt="" /></a>
                                        @endif
                                      </div>
                                      ...
                                      <div class="sidebar-add">
                                        @if($vertical8==NULL)
                                        @else
                                        <a href="{{ $vertical8->link }}" target="_blank"><img src="{{ asset($vertical8->ads) }}" alt="" /></a>
                                        @endif
                                      </div>
